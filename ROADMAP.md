...
| 4 | **Transactions + cross-entity contracts** | the money shape: move value atomically or not at all | multi-effect actions in one transaction; `ensures` spanning affected rows |
