"""The miurac command line: check, fmt, unpack, test.
...
def _header(app, src_path: str) -> str:
    return (
        f"GENERATED BY miurac v{VERSION} FROM {os.path.basename(src_path)} — DO NOT EDIT.\n"
        f"Edit the bundle and re-run: python -m miurac unpack {os.path.basename(src_path)}\n"
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(prog="miurac", description="Miura bundle compiler: check, format, test, and unpack .miura bundles.")
